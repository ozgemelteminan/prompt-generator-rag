...
export function DocumentsExperience() {
  ...
  return <section className="mx-auto max-w-5xl space-y-8">
    <header className="space-y-3"><p className="pf-eyebrow">PromptForge</p><h1 className="pf-page-title">{text.title}</h1><p className="max-w-2xl leading-7 pf-muted">{text.description}</p><LanguageToggle language={language} onChange={setLanguage} /></header>
