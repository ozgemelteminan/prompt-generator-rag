...
| File | Capture state | Portfolio purpose |
| --- | --- | --- |
| `create.png` | Create page with a natural-language request and language control | Main product entry point |
| `clarification.png` | Compact clarification form after intent analysis | Structured gap handling |
| `generated-prompt.png` | Ready optimized prompt with Copy / Favorite / Run actions | Deterministic compilation outcome |
| `documents.png` | Documents library showing a Ready document | Document preparation state |
...
Screenshots are pending real capture and are intentionally absent from Git until
they can be reviewed for privacy and accuracy.
